...
/**
 * Check if a directory exists, create one if not
 *
 * @example
 ...
 * @param {String} path
 * @param {Function} next
 * @callbackParam {Error|Object} err - The error details
 */
...
/**
 * Call to save parsed docs as "docs.json" in the directory given
 *
 * @example
 *    saveResults( docs, dir, function (err) {
 *      if ( ! err ) {
 *        // Saved
 *      }
 *    });
 ...
 * @private
 * @param {Object} data
 * @param {String} dir - path to directory to save the data object as file
 * @param {Function} next
 */

function saveResults (data, dir, next) {
